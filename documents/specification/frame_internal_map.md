...
| 15 | [15_frame_jobs.md](15_frame_jobs.md) | Background job queue, scheduled tasks, retry policies |
| 16 | [16_frame_locale.md](16_frame_locale.md) | Internationalization — translations, plurals, locale-aware formatting |
| 17 | [17_frame_mcp.md](17_frame_mcp.md) | MCP server plugin — tools, resources, prompts over stdio and HTTP+SSE |
| 18 | [18_frame_client.md](18_frame_client.md) | Client-side communication via frame.client plugin (api.*, live.*, feed.* namespaces; `load:`, `form:`, `send:` blocks) |
| -- | [frame_bridge_contracts.md](frame_bridge_contracts.md) | Host Bridge JSON contracts, WASM imports, platform availability |

> **Reserved numbers:** `19_` and above are reserved for future plugin specs to avoid the past `15_` collision.
...
│  MCP              (17) ──▶ host:mcp bridge │
│  Jobs             (15) ──▶ queue bridge    │
│  Locale           (16) ──▶ i18n + format   │
│  Guidelines       (09)                     │
│  Future           (13)                     │
└────────────────────────────────────────────┘
```
...
| `host:mcp` | 17_frame_mcp.md §13 | MCP (stdio_read, stdio_write, http_serve, http_accept, sse_send, log) |
...
| Add client-side communication (api/live/feed) | 18_frame_client.md |
...
| Build an MCP server for AI agents | 17_frame_mcp.md |
