...
# Use compiler 0.31.0 — fixes NO-OP string stubs from 0.22.0
# and avoids `rules` keyword conflict in 0.30.38
...
echo "Built frame.ui plugin -> plugin.wasm (compiler 0.31.0)"
